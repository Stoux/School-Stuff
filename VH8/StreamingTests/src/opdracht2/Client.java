...
public class Client{
  ...
  static int RTP_RCV_PORT = 0; //port where the client will receive the RTP packets
  ...
  public Client() {
    ...
    iconLabel.setBounds(50,50,1000,1000);
  ...
  public static void main(String argv[]) throws Exception
  {
    ...
    //------------------
    int RTSP_server_port = 8080; //Integer.parseInt(argv[1]);
    String ServerHost = "84.84.208.93"; //argv[0];
	  ...
	  public void actionPerformed(ActionEvent e){
		  ...
		  if (state == INIT) {
			  ...
			  try {
				  ...
				  RTP_RCV_PORT = 25000;//RTPsocket.getLocalPort();

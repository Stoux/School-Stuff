...
public class TimeFrame extends javax.swing.JFrame {
    ...
    public TimeFrame() {
        ...
        addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent e) {
                O2Entity.date = new Date(selectedDate.getDate().getTime());
                dispose();
                selected = true;
            }
    ...
    private void initComponents() {
        ...
        selectedDate = new org.jdesktop.swingx.JXDatePicker();

        setDefaultCloseOperation(javax.swing.WindowConstants.DO_NOTHING_ON_CLOSE);

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel1.setText("Selecteer datum van deze SnapShot");
    ...
    private org.jdesktop.swingx.JXDatePicker selectedDate;
